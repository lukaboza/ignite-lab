            ...
            <div className="p-8 max-w-[1100px] mx-auto">
                <div className="flex items-start gap-16">
                    ...
                    <div className="flex flex-col gap-4">
                        <a href="#" className="p-4 text-sm bg-green-500 flex items-center rounded font-bold uppercase gap-2 justify-center hover:bg-green-900 transition-colors">   {/* hover padrão: hover:bg-green-700 */}
                            <DiscordLogo size={24} />
                            Comucidade do discord
                        </a>
                ...
                <div className="gap-8 mt-20 grid grid-cols-2">
                    <a 
                        ...
                        href="">
                            ...
                            <div className="py-6 leading-relaxed">
                                <strong className="text2xl">Wallpapers ignite lab</strong>
                                <p className="text-sm text-gray-200 mt-2">
                                    wallpapers destinados e distribuidos pela rocketseat, destinado ao ignite lab.
                                </p>
                            </div>
                            <div className="h-full p-6 flex items-center">
                                <CaretRight size={24}/>
